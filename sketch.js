...
ground = createSprite(200,380,3200,20);
...
gameOver = createSprite(600,275);
restart = createSprite(600,340);
...
function spawnObstacles() {
  if(World.frameCount % 150 === 0) {
    var obstacle = createSprite(1300,365,10,40);
...
function spawnClouds() {
  ...
  if (World.frameCount % 60 === 0) {
    var cloud = createSprite(1200,320,40,10);
